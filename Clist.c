...
bool add(clist *l, DATA data, int pos){//quedaigul porque inserta en el medio
    if(l==NULL) return false;
    if(pos == 0 || is_empty(l)){
...
node *serch_node(clist *l, DATA data);//solo mostrara el apuntador del nodo
